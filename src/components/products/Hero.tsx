...
function Hero() {
  return (
    <React.Fragment>
      <section className="  lg:mt-[100px] mt-[80px]  w-full  lg:min-h-[calc(100vh-100px)] relative min-h-[calc(90vh-80px)]  ">
        ...
        <h2 className="lg:text-3xl font-medium text-2xl pt-4 my-7 text-center ">
